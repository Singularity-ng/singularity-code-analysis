...
pub enum Javascript {
    ...
    YieldExpression = 181,
    Object = 182,
    ObjectCodePattern = 183,
    AssignmentCodePattern = 184,
    ObjectAssignmentCodePattern = 185,
    Array = 186,
    ArrayCodePattern = 187,
    JsxElement = 188,
    JsxExpression = 189,
    ...
    ObjectRepeat1 = 247,
    ObjectCodePatternRepeat1 = 248,
    ArrayRepeat1 = 249,
    ArrayCodePatternRepeat1 = 250,
...
impl From<Javascript> for &'static str {
    ...
    fn from(tok: Javascript) -> Self {
        match tok {
            ...
            Javascript::SLASH2 => "/",
            Javascript::RegexCodePattern => "regex_pattern",
            ...
            Javascript::ObjectCodePattern => "object_pattern",
            Javascript::AssignmentCodePattern => "assignment_pattern",
            Javascript::ObjectAssignmentCodePattern => "object_assignment_pattern",
            Javascript::Array => "array",
            Javascript::ArrayCodePattern => "array_pattern",
            ...
            Javascript::DestructuringCodePattern => "_destructuring_pattern",
            ...
            Javascript::CodePattern => "pattern",
            Javascript::RestCodePattern => "rest_pattern",
            Javascript::MethodDefinition => "method_definition",
            Javascript::Pair => "pair",
            Javascript::PairCodePattern => "pair_pattern",
            ...
            Javascript::ObjectCodePatternRepeat1 => "object_pattern_repeat1",
            Javascript::ArrayRepeat1 => "array_repeat1",
            Javascript::ArrayCodePatternRepeat1 => "array_pattern_repeat1",
