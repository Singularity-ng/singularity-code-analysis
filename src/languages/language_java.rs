...
pub enum Java {
    ...
    CodePattern = 179,
    TypeCodePattern = 180,
    RecordCodePattern = 181,
    RecordCodePatternBody = 182,
    RecordCodePatternComponent = 183,
    Guard = 184,
    Statement = 185,
    Block = 186,
    ...
    RecordCodePatternBodyRepeat1 = 296,
...
impl From<Java> for &'static str {
    ...
    fn from(tok: Java) -> Self {
        match tok {
            ...
            Java::UnderscoreCodePattern => "underscore_pattern",
            Java::When => "when",
            Java::SEMI => ";",
            Java::Assert => "assert",
            Java::Do => "do",
            ...
            Java::CodePattern => "pattern",
            Java::TypeCodePattern => "type_pattern",
            Java::RecordCodePattern => "record_pattern",
            Java::RecordCodePatternBody => "record_pattern_body",
            Java::RecordCodePatternComponent => "record_pattern_component",
            Java::Guard => "guard",
            ...
            Java::RecordCodePatternBodyRepeat1 => "record_pattern_body_repeat1",
