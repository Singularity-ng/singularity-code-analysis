...
pub enum Typescript {
    ...
    YieldExpression = 212,
    Object = 213,
    ObjectCodePattern = 214,
    AssignmentCodePattern = 215,
    ObjectAssignmentCodePattern = 216,
    Array = 217,
    ArrayCodePattern = 218,
    ...
    ObjectRepeat1 = 358,
    ObjectCodePatternRepeat1 = 359,
    ArrayRepeat1 = 360,
    ArrayCodePatternRepeat1 = 361,
...
impl From<Typescript> for &'static str {
    ...
    fn from(tok: Typescript) -> Self {
        match tok {
            ...
            Typescript::SLASH2 => "/",
            Typescript::RegexCodePattern => "regex_pattern",
            ...
            Typescript::ObjectCodePattern => "object_pattern",
            Typescript::AssignmentCodePattern => "assignment_pattern",
            Typescript::ObjectAssignmentCodePattern => "object_assignment_pattern",
            Typescript::Array => "array",
            Typescript::ArrayCodePattern => "array_pattern",
            ...
            Typescript::DestructuringCodePattern => "_destructuring_pattern",
            ...
            Typescript::CodePattern => "pattern",
            Typescript::RestCodePattern => "rest_pattern",
            Typescript::MethodDefinition => "method_definition",
            Typescript::Pair => "pair",
            Typescript::PairCodePattern => "pair_pattern",
            ...
            Typescript::ObjectCodePatternRepeat1 => "object_pattern_repeat1",
            Typescript::ArrayRepeat1 => "array_repeat1",
            Typescript::ArrayCodePatternRepeat1 => "array_pattern_repeat1",
