...
pub enum Tsx {
    ...
    YieldExpression = 218,
    Object = 219,
    ObjectCodePattern = 220,
    AssignmentCodePattern = 221,
    ObjectAssignmentCodePattern = 222,
    Array = 223,
    ArrayCodePattern = 224,
    JsxElement = 225,
    JsxExpression = 226,
    ...
    ObjectRepeat1 = 371,
    ObjectCodePatternRepeat1 = 372,
    ArrayRepeat1 = 373,
    ArrayCodePatternRepeat1 = 374,
    ...
    ShorthandPropertyIdentifierCodePattern = 396,
...
impl From<Tsx> for &'static str {
    ...
    fn from(tok: Tsx) -> Self {
        match tok {
            ...
            Tsx::DOLLARLBRACE => "${",
            Tsx::SLASH2 => "/",
            Tsx::RegexCodePattern => "regex_pattern",
            ...
            Tsx::Object => "object",
            Tsx::ObjectCodePattern => "object_pattern",
            Tsx::AssignmentCodePattern => "assignment_pattern",
            Tsx::ObjectAssignmentCodePattern => "object_assignment_pattern",
            Tsx::Array => "array",
            Tsx::ArrayCodePattern => "array_pattern",
            ...
            Tsx::DestructuringCodePattern => "_destructuring_pattern",
            ...
            Tsx::CodePattern => "pattern",
            Tsx::RestCodePattern => "rest_pattern",
            Tsx::MethodDefinition => "method_definition",
            Tsx::Pair => "pair",
            Tsx::PairCodePattern => "pair_pattern",
            ...
            Tsx::ObjectCodePatternRepeat1 => "object_pattern_repeat1",
            Tsx::ArrayRepeat1 => "array_repeat1",
            Tsx::ArrayCodePatternRepeat1 => "array_pattern_repeat1",
            ...
            Tsx::ShorthandPropertyIdentifierCodePattern => "shorthand_property_identifier_pattern",
