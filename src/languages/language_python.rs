...
pub enum Python {
    ...
    DottedName = 162,
    CaseCodePattern = 163,
    SimpleCodePattern = 164,
    AsCodePattern = 165,
    UnionCodePattern = 166,
    ListCodePattern = 167,
    TupleCodePattern = 168,
    DictCodePattern = 169,
    KeyValueCodePattern = 170,
    KeywordCodePattern = 171,
    SplatCodePattern = 172,
    ClassCodePattern = 173,
    ComplexCodePattern = 174,
    Parameters2 = 175,
    CodePatterns = 176,
    Parameter = 177,
    CodePattern = 178,
    TupleCodePattern2 = 179,
    ListCodePattern2 = 180,
    DefaultParameter = 181,
    TypedDefaultParameter = 182,
    ListSplatCodePattern = 183,
    DictionarySplatCodePattern = 184,
    AsCodePattern2 = 185,
    ...
    UnionCodePatternRepeat1 = 258,
    DictCodePatternRepeat1 = 259,
    ParametersRepeat1 = 260,
    CodePatternsRepeat1 = 261,
...
impl From<Python> for &'static str {
    ...
    fn from(tok: Python) -> Self {
        match tok {
            ...
            Python::CaseCodePattern => "case_pattern",
            Python::SimpleCodePattern => "_simple_pattern",
            Python::AsCodePattern => "as_pattern",
            Python::UnionCodePattern => "union_pattern",
            Python::ListCodePattern => "list_pattern",
            Python::TupleCodePattern => "tuple_pattern",
            Python::DictCodePattern => "dict_pattern",
            Python::KeyValueCodePattern => "_key_value_pattern",
            Python::KeywordCodePattern => "keyword_pattern",
            Python::SplatCodePattern => "splat_pattern",
            Python::ClassCodePattern => "class_pattern",
            Python::ComplexCodePattern => "complex_pattern",
            Python::Parameters2 => "_parameters",
            Python::CodePatterns => "_patterns",
            Python::Parameter => "parameter",
            Python::CodePattern => "pattern",
            Python::TupleCodePattern2 => "tuple_pattern",
            Python::ListCodePattern2 => "list_pattern",
            Python::DefaultParameter => "default_parameter",
            Python::TypedDefaultParameter => "typed_default_parameter",
            Python::ListSplatCodePattern => "list_splat_pattern",
            Python::DictionarySplatCodePattern => "dictionary_splat_pattern",
            Python::AsCodePattern2 => "as_pattern",
            ...
            Python::CodePatternList => "pattern_list",
            ...
            Python::UnionCodePatternRepeat1 => "union_pattern_repeat1",
            Python::DictCodePatternRepeat1 => "dict_pattern_repeat1",
            Python::ParametersRepeat1 => "_parameters_repeat1",
            Python::CodePatternsRepeat1 => "_patterns_repeat1",
            ...
            Python::AsCodePatternTarget => "as_pattern_target",
