...
pub enum Mozjs {
    ...
    YieldExpression = 170,
    Object = 171,
    ObjectCodePattern = 172,
    AssignmentCodePattern = 173,
    ObjectAssignmentCodePattern = 174,
    Array = 175,
    ArrayCodePattern = 176,
    GlimmerTemplate = 177,
    ...
    ObjectRepeat1 = 238,
    ObjectCodePatternRepeat1 = 239,
    ArrayRepeat1 = 240,
    ArrayCodePatternRepeat1 = 241,
...
impl From<Mozjs> for &'static str {
    ...
    fn from(tok: Mozjs) -> Self {
        match tok {
            ...
            Mozjs::Template => "<template>",
            Mozjs::Template2 => "</template>",
            Mozjs::LT => "<",
            Mozjs::GT => ">",
            Mozjs::SLASH => "/",
            ...
            Mozjs::DOLLARLBRACE => "${",
            Mozjs::SLASH2 => "/",
            Mozjs::RegexCodePattern => "regex_pattern",
            ...
            Mozjs::Object => "object",
            Mozjs::ObjectCodePattern => "object_pattern",
            Mozjs::AssignmentCodePattern => "assignment_pattern",
            Mozjs::ObjectAssignmentCodePattern => "object_assignment_pattern",
            Mozjs::Array => "array",
            Mozjs::ArrayCodePattern => "array_pattern",
            ...
            Mozjs::DestructuringCodePattern => "_destructuring_pattern",
            ...
            Mozjs::CodePattern => "pattern",
            Mozjs::RestCodePattern => "rest_pattern",
            Mozjs::MethodDefinition => "method_definition",
            Mozjs::Pair => "pair",
            Mozjs::PairCodePattern => "pair_pattern",
            ...
            Mozjs::ObjectCodePatternRepeat1 => "object_pattern_repeat1",
            Mozjs::ArrayRepeat1 => "array_repeat1",
            Mozjs::ArrayCodePatternRepeat1 => "array_pattern_repeat1",
